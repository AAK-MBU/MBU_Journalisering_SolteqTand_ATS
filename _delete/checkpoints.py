...
def _process_note_creation() -> None:
    """Create administrative note in Solteq"""
    # Create administrative note in Solteq based on form input
    create_journalnote(
    ...
    # Create administrative note in Solteq based on consent to send journal material
